...
public abstract class AbstractCommand implements CommandExecutor, TabExecutor {
    ...
    protected InfiniteObsidianPlugin plugin;
    ...
    protected boolean hasPermission(CommandSender sender, String permission) {
        return sender.hasPermission(InfiniteObsidianPlugin.PERMISSION_PREFIX + "." + permission);
    }
    ...
    protected void help(CommandSender sender, String[] args) {
        ...
        List<String> commands = Arrays.asList(
                "infiniteObsidian help",
                "infiniteObsidian reload",
                "infiniteObsidian version",
                "infiniteObsidian give <player> [amt]"
        );
