...
public class MsgUtil {
    ...
    public static String papi(CommandSender sender, String s) {
        if (!InfiniteObsidianPlugin.getPlugin().isHookEnabled("papi") || !(sender instanceof Player)) return s;
        return InfiniteObsidianPlugin.getPlugin().getHook(PlaceholderAPIHook.class).replace((Player) sender, s);
    }
