...
public class ConfigManager extends AbstractManager {
     ...
     * @return - New file com.i0dev.plugin.potfill.object
     */
    ...
    /**
     * Create new file for com.i0dev.plugin.potfill.config and copy resource into it
     *
     * @param filePath - Path to file
    ...
    public void prepareFile(String filePath, String resource) {
        ...
        try {
            ...
            if (resource != null && !resource.isEmpty()) {
                this.copyResource(InfiniteObsidianPlugin.getPlugin().getResource(resource), file);
            }
    ...
    /**
     * Create new file for com.i0dev.plugin.potfill.config without resource
     *
    ...
    /**
     * Adds header block to com.i0dev.plugin.potfill.config
     *
    ...
    /*
     * Get com.i0dev.plugin.potfill.config content from file
     * @param filePath - Path to file
     * @return - readied file
     */
    ...
    public String getPluginName() {
        return InfiniteObsidianPlugin.getPlugin().getDescription().getName();
    }
